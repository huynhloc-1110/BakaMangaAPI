...
namespace BakaMangaAPI.Data.Migrations
{
    ...
    [Migration("20231026083845_AddUserBannedUntil")]
    partial class AddUserBannedUntil
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.ApplicationUserFollow", b =>
                {
                    ...
                    b.ToTable("ApplicationUserFollows");
                });
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.Notification", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.ChapterNotification", b =>
                {
                    b.HasBaseType("BakaMangaAPI.Models.Notification");
                    ...
                    b.HasDiscriminator().HasValue("ChapterNotification");
                });
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.FollowerNotification", b =>
                {
                    b.HasBaseType("BakaMangaAPI.Models.Notification");

                    b.Property<string>("FollowedPersonId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.GroupNotification", b =>
                {
                    b.HasBaseType("BakaMangaAPI.Models.Notification");
                    ...
                    b.HasDiscriminator().HasValue("GroupNotification");
                });

            modelBuilder.Entity("BakaMangaAPI.Models.GroupPost", b =>
                {
                    b.HasBaseType("BakaMangaAPI.Models.Post");
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.JoinGroupRequest", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("JoinGroupRequest");
                });
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.MangaRequest", b =>
                {
                    b.HasBaseType("BakaMangaAPI.Models.Request");
                    ...
                    b.HasDiscriminator().HasValue("MangaRequest");
                });

            modelBuilder.Entity("BakaMangaAPI.Models.OtherRequest", b =>
                {
                    b.HasBaseType("BakaMangaAPI.Models.Request");
                    ...
                    b.HasDiscriminator().HasValue("OtherRequest");
                });
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.RequestNotification", b =>
                {
                    b.HasBaseType("BakaMangaAPI.Models.Notification");
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.UserPost", b =>
                {
                    b.HasBaseType("BakaMangaAPI.Models.Post");
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.ApplicationUserFollow", b =>
                {
                    b.HasOne("BakaMangaAPI.Models.ApplicationUser", "FollowedUser")
                        .WithMany("Followers")
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.FollowerNotification", b =>
                {
                    b.HasOne("BakaMangaAPI.Models.ApplicationUser", "FollowedPerson")
                        .WithMany()
            ...
            modelBuilder.Entity("BakaMangaAPI.Models.RequestNotification", b =>
                {
                    b.HasOne("BakaMangaAPI.Models.Request", "Request")
                        .WithMany()
