...
namespace BakaMangaAPI.Data.Migrations
{
    ...
    [Migration("20230911080409_AddMangaList")]
    partial class AddMangaList
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MangaMangaList", b =>
                {
                    b.Property<string>("MangaListsId")
                        .HasColumnType("text");

                    b.Property<string>("MangasId")
                        .HasColumnType("text");

                    b.HasKey("MangaListsId", "MangasId");
            ...
            modelBuilder.Entity("MangaMangaList", b =>
                {
                    b.HasOne("BakaMangaAPI.Models.MangaList", null)
                        .WithMany()
                        .HasForeignKey("MangaListsId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
